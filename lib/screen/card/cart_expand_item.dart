...
class CartExpandItem extends StatelessWidget {
  final ShopList model;
  final Function(String) onSum;
  const CartExpandItem({
    Key? key,
    required this.model,
    required this.onSum,
  }) : super(key: key);
...
class CartExpandItemBody extends StatefulWidget {
  final Function(String) onSum;
  const CartExpandItemBody({Key? key, required this.onSum}) : super(key: key);

  @override
  _CartExpandItemBodyState createState() => _CartExpandItemBodyState();
}

class _CartExpandItemBodyState extends State<CartExpandItemBody> {
