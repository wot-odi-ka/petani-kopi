...
class TambahProductPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ], child: const TambahProductBoddy());
  }
}

class TambahProductBoddy extends StatefulWidget {
  const TambahProductBoddy({Key? key}) : super(key: key);

  @override
  _TambahProductBoddyState createState() => _TambahProductBoddyState();
}

class _TambahProductBoddyState extends State<TambahProductBoddy> {
