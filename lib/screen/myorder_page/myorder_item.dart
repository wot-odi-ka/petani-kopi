...
class MyOrderItems extends StatefulWidget {
  ...
  @override
  State<MyOrderItems> createState() => _MyOrderItemsState();
}

class _MyOrderItemsState extends State<MyOrderItems> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Visibility(
                          visible: widget.model.processStatus == Const.send,
                          child: Expanded(
                            child: Card(
                              color: dashboardColor,
                              elevation: 5,
                              child: ListTile(
                                onTap: () {
                                  widget.model.processStatus = Const.done;
